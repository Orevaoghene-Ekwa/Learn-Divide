...
const CreateCourse = () => {
  ...
  return (
    <div className="flex min-h-screen w-screen mt-16 flex-col md:flex-row">
  {/* Sidebar */}
  <div className="w-full md:w-1/3 p-6 md:border-r-6 bg-gray-900/80">
  ...
  {/* Preview Section - Hidden on md and below */}
  <div className="hidden md:block w-2/3 min-h-screen text-gray-300 p-6">
    ...
    <div className="p-4 rounded shadow">
      ...
      <p className="font-semibold bg-gradient-to-r from-green-400 to-emerald-500 text-transparent bg-clip-text">
        Price: ${price || "0.00"}
      </p>
      {videos.length > 0 ? (
        videos.map((video, index) => (
